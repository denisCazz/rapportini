        ...
        <div className="space-y-3">
          {filteredRapportini.length === 0 ? (
            ...
            filteredRapportini.map((rapportino) => (
              ...
              >
                <div className={`absolute top-0 left-0 w-1 h-full ${rapportino.intervento.tipoStufa === 'pellet' ? 'bg-orange-500' : 'bg-amber-600'}`} />
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6">
                    <div className="flex-1 min-w-0 space-y-4">
                      ...
                      <div>
                        ...
                        {rapportino.cliente.ragioneSociale && (
                          <p className="text-sm text-gray-500 dark:text-gray-400">{rapportino.cliente.ragioneSociale}</p>
                        )}
                      </div>
                    ...
                    <div className="flex flex-row lg:flex-col gap-2 shrink-0">
                      <button
                        ...
                        className="px-4 py-2.5 bg-primary-600 text-white rounded-xl hover:bg-primary-700 transition-all text-sm font-medium shadow-sm hover:shadow-md flex items-center justify-center gap-2"
                      >
                      ...
                      {onEdit && (
                        <button
                          ...
                          className="px-4 py-2.5 bg-amber-500/10 dark:bg-amber-500/20 text-amber-700 dark:text-amber-300 border border-amber-300/50 dark:border-amber-600/50 rounded-xl hover:bg-amber-500/20 dark:hover:bg-amber-500/30 transition-all text-sm font-medium flex items-center justify-center gap-2"
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <button
                        ...
                        className="px-4 py-2.5 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 border border-red-200/80 dark:border-red-800/50 rounded-xl hover:bg-red-100 dark:hover:bg-red-900/30 transition-all text-sm font-medium flex items-center justify-center gap-2"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
