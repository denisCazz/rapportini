          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 pb-4 sm:pb-6 border-b-2 border-gray-300 dark:border-gray-600 print:border-gray-800 gap-4">
            ...
            <div className="flex flex-wrap gap-2 print:hidden w-full sm:w-auto">
              {onEdit && (
                <button
                  onClick={onEdit}
                  className="flex-1 sm:flex-none px-4 py-2 bg-amber-600 text-white rounded-lg hover:bg-amber-700 transition-colors text-sm sm:text-base flex items-center gap-2"
                >
